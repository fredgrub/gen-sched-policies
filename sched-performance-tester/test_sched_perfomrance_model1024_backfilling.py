...
for i in xrange(0,NUM_EXPERIMENTS): #1e7  
  ...
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_day_1024.xml -bf -saf -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  ...
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_day_1024.xml -bf -linear -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)  
  _buffer.close()
