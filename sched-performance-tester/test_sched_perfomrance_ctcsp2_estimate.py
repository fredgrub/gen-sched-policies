...
for i in xrange(0,NUM_EXPERIMENTS): #1e7  
  ...
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_ctcsp2.xml -saf -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)
  ...
  subprocess.call(['./sched-simulator-estimate-backfilling xmls/plat_day.xml xmls/deployment_ctcsp2.xml -linear -nt '+str(number_of_tasks)], shell=True, stdout=_buffer)  
  _buffer.close()
...
xoffset=[0.39,0.39,0.39,0.39,0.39,0.39,0.39]
ylow=[1000,1000,1000,1000,1000,1000,1000]
